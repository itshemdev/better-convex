...
For polymorphic tables with multiple `one()` targets, you can synthesize typed discriminated unions at query time. See [Typed Query Synthesis](/docs/orm/schema/relations#typed-query-synthesis-polymorphic) in the Relations guide.
