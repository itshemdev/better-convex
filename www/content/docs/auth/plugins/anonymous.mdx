...
In this guide, we'll explore anonymous authentication with better-convex. You'll learn to configure guest sessions, let users browse without signing up, and seamlessly link anonymous accounts to real ones — migrating their data along the way.
...
import { boolean, convexTable, defineSchema, text } from 'better-convex/orm';
